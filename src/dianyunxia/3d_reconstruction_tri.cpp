/*
 * @Author: glider
 * @Date: 2023-07-06 14:51:37
 * @LastEditTime: 2023-07-06 20:25:56
 * @FilePath: /SubstrateDevelopment/src/dianyunxia/3d_reconstruction_tri.cpp
 * @Version:  v0.01
 * @Description: 
 * ************************************************************************
...
main()
{
    ...
    pcl::io::loadPCDFile("/home/admins/project/SubstrateDevelopment/data/pcl/bunny.pcd", cloud_blob);
